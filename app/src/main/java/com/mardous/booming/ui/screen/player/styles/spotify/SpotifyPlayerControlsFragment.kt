...
import com.mardous.booming.databinding.FragmentSpotifyPlayerPlaybackControlsBinding
...
class SpotifyPlayerControlsFragment : AbsPlayerControlsFragment(R.layout.fragment_spotify_player_playback_controls) {
    ...
    override fun getTintTargets(scheme: PlayerColorScheme): List<PlayerTintTarget> {
        ...
        return listOfNotNull(
            ...
            binding.progressSlider.progressView?.tintTarget(oldSliderColor, activeControlColor),
