...
class StatsCache(
    ...
    private fun refresh() {
        applicationScope.launch(Dispatchers.IO) {
            ...
            songDurations.clear()
            val topSongs = listeningHistoryDao.getTopSongs(Int.MAX_VALUE)
            topSongs.forEach { 
            ...
            val topAlbums = listeningHistoryDao.getTopAlbums(Int.MAX_VALUE)
            topAlbums.forEach { 
            ...
            val topArtists = listeningHistoryDao.getTopArtists(Int.MAX_VALUE)
            topArtists.forEach { 
