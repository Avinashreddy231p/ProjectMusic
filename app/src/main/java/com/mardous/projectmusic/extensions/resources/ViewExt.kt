...
const val PROJECT_MUSIC_ANIM_TIME = 350L
...
fun View.show(animate: Boolean = false, onCompleted: AnimationCompleted? = null) {
    if (!animate) {
        ...
        this.animate()
            .alpha(1f)
            .setDuration(PROJECT_MUSIC_ANIM_TIME)
            .withStartAction {
    ...
    return ValueAnimator.ofArgb(fromColor, toColor).apply {
        ...
        addUpdateListener { animation ->
            ...
            if (isForeground) {
                ...
                is MusicSlider -> currentColor = animatedColor
...
fun NavigationBarView.show() {
    ...
    ValueAnimator.ofInt(parent.height, top).apply {
        duration = PROJECT_MUSIC_ANIM_TIME
...
inline fun Context.createProjectMusicBalloon(
    tooltipId: String,
    lifecycleOwner: LifecycleOwner,
