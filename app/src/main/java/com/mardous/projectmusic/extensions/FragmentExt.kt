...
import com.mardous.projectmusic.extensions.resources.createProjectMusicBalloon
...
inline fun Fragment.createProjectMusicBalloon(
    tooltipId: String,
    crossinline block: Balloon.Builder.() -> Unit
) = requestContext { it.createProjectMusicBalloon(tooltipId, viewLifecycleOwner, block = block) }
