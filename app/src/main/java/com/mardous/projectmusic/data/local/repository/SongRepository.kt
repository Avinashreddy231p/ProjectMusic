...
import com.mardous.projectmusic.extensions.utilities.getStringSafe
...
class RealSongRepository(
    ...
    override fun songs(songIds: List<Long>): List<Song> {
        ...
        val allFetched = buildList {
            songIds.chunked(900).forEach { chunk ->
        ...
        // Restore input order
        val songMap = allFetched.associateBy { it.id }
    ...
    override fun makeSongCursor(queryDispatcher: MediaQueryDispatcher, ignoreBlacklist: Boolean): Cursor? {
