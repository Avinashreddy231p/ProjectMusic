...
import com.mardous.projectmusic.core.sort.ArtistSortMode
...
import com.mardous.projectmusic.extensions.utilities.collapseSpaces
...
class RealArtistRepository(
    ...
    private val metadataDao: com.mardous.projectmusic.data.local.database.dao.MetadataDao
) : ArtistRepository {
    ...
    override fun artist(artistId: Long): Artist {
        ...
        val entity = kotlinx.coroutines.runBlocking { metadataDao.getArtistById(artistId) }
        return Artist(
            id = artistId,
            ...
            overallRank = entity?.overallRank ?: 0,
            playCount = entity?.playCount ?: 0L,
            listeningDuration = entity?.listeningDuration ?: 0L,
            overallScore = entity?.overallScore ?: 0.0,
            playRank = entity?.playRank ?: 0,
            durationRank = entity?.durationRank ?: 0
        )
    }
    ...
    override fun albumArtist(artistName: String): Artist {
        ...
        val entity = kotlinx.coroutines.runBlocking { metadataDao.getArtistByName(artistName) }
        return Artist(
    ...
    override fun splitIntoAlbumArtists(albums: List<Album>): List<Artist> {
        val filterSingles = this.filterSingles
