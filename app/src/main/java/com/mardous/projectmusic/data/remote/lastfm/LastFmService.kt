...
package com.mardous.projectmusic.data.remote.lastfm
...
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmUserResponse
...
import com.mardous.projectmusic.util.encodeMd5
...
class LastFmService(private val client: HttpClient) {
    ...
    suspend fun scrobbleBatch(
        scrobbles: List<com.mardous.projectmusic.data.local.database.analytics.PendingScrobbleEntity>,
        sk: String
    ): Any {
