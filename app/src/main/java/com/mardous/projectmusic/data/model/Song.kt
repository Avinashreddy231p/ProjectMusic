...
import com.mardous.projectmusic.data.local.repository.RealSongRepository.Companion.getAudioContentUri
...
open class Song(
    ...
    companion object {
        val emptySong = Song(-1, "", "", -1, -1, -1, -1, -1, -1, -1, "", -1, "", "", "", volumeName = null)
    }
}
