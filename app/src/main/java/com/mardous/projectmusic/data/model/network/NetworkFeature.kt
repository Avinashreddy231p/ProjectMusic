package com.mardous.projectmusic.data.model.network
...
import com.mardous.projectmusic.util.UpdateSearchMode
    ...
    sealed class Lastfm(preferenceKey: String, isOnByDefault: Boolean) :
        ...
        object Scrobbling : Lastfm(LASTFM_SCROBBLING_ENABLED_KEY, false) {
            override val isAvailable: Boolean
                get() = if (isEnabled) {
                    if (com.mardous.projectmusic.util.Preferences.lastfmOfflineScrobbling) true else isOnline()
                } else false
        }
