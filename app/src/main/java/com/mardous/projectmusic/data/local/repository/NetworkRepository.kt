...
import com.mardous.projectmusic.data.model.network.ScrobblingResult
import com.mardous.projectmusic.data.model.network.ScrobblingService
import com.mardous.projectmusic.data.model.network.lastfm.LastFmFailure
import com.mardous.projectmusic.data.remote.deezer.DeezerService
import com.mardous.projectmusic.data.remote.deezer.model.DeezerAlbum
import com.mardous.projectmusic.data.remote.deezer.model.DeezerArtist
import com.mardous.projectmusic.data.remote.deezer.model.DeezerTrack
import com.mardous.projectmusic.data.remote.lastfm.LastFmService
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmAlbum
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmArtist
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmError
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmRecentTracksResponse
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmSessionResponse
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmTopAlbumsResponse
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmTopArtistsResponse
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmTopTracksResponse
import com.mardous.projectmusic.data.remote.lastfm.model.LastFmUser
import com.mardous.projectmusic.data.remote.lastfm.model.NowPlayingResponse
import com.mardous.projectmusic.data.remote.lastfm.model.ScrobbleResponse
import com.mardous.projectmusic.data.remote.listenbrainz.ListenBrainzService
import com.mardous.projectmusic.data.remote.listenbrainz.model.ListenBrainzListen
import com.mardous.projectmusic.data.remote.listenbrainz.model.ListenBrainzSubmission
import com.mardous.projectmusic.data.remote.listenbrainz.model.ListenBrainzTrackAdditionalInfo
import com.mardous.projectmusic.data.remote.listenbrainz.model.ListenBrainzTrackMetadata
...
class NetworkRepositoryImpl(
    ...
    private val pendingScrobbleDao: com.mardous.projectmusic.data.local.database.dao.PendingScrobbleDao
) : NetworkRepository {
    ...
    private suspend fun scrobbleToLastfm(song: Song, timestamp: Long): ScrobblingResult {
        ...
        try {
            ...
            if (com.mardous.projectmusic.util.Preferences.lastfmOfflineScrobbling) {
                pendingScrobbleDao.insert(
                    com.mardous.projectmusic.data.local.database.analytics.PendingScrobbleEntity(
                        artist = song.displayArtistName(),
                        track = song.title,
                        album = song.albumName,
                        timestamp = timestamp
    ...
    private suspend fun syncPendingScrobbles(sk: String) {
        if (!com.mardous.projectmusic.util.Preferences.lastfmOfflineScrobbling) return
        try {
            ...
            pending.chunked(50).forEach { batch ->
                ...
                if (response is com.mardous.projectmusic.data.remote.lastfm.model.ScrobbleResponse) {
