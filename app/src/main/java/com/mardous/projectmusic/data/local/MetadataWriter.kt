package com.mardous.projectmusic.data.local
...
import com.mardous.projectmusic.extensions.media.createAlbumArtThumbFile
import com.mardous.projectmusic.extensions.media.deleteAlbumArt
import com.mardous.projectmusic.extensions.media.insertAlbumArt
...
class MetadataWriter : KoinComponent {
    ...
    private fun createPicture(target: EditTarget): Picture? {
        ...
        return Picture(
            data = byteArray,
            description = "Embedded Front Cover - Project Music",
