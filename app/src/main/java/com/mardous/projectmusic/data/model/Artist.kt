...
data class Artist(
    ...
    constructor(
        ...
        isAlbumArtist: Boolean = true,
        overallRank: Int = 0,
        playCount: Long = 0L,
        listeningDuration: Long = 0L,
        overallScore: Double = 0.0,
        playRank: Int = 0,
        durationRank: Int = 0,
        about: String? = null
    ) : this(albums.firstOrNull()?.artistId ?: -1, albums, filterSingles, true, overallRank, playCount, listeningDuration, overallScore, playRank, durationRank, about)
