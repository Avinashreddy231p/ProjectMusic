...
package com.mardous.projectmusic.core.model.player
...
import com.mardous.projectmusic.extensions.resources.adjustSaturationIfTooHigh
import com.mardous.projectmusic.extensions.resources.desaturateIfTooDarkComparedTo
import com.mardous.projectmusic.extensions.resources.ensureContrastAgainst
import com.mardous.projectmusic.extensions.resources.onSurfaceColor
...
import com.mardous.projectmusic.extensions.systemContrast
import com.mardous.projectmusic.ui.component.compose.color.onThis
...
data class PlayerColorScheme(
    ...
    companion object {
        ...
        val Unspecified = PlayerColorScheme(
            ...
            surfaceColor = Color.parseColor("#121212"),
            surfaceContainerColor = Color.parseColor("#1E1E1E"),
            primaryColor = Color.GRAY,
            secondaryContainerColor = Color.parseColor("#2C2C2C"),
            onSurfaceColor = Color.WHITE,
            onSurfaceVariantColor = Color.LTGRAY
        )
