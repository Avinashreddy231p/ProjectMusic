...
sealed class KeySortItem(id: Int, title: Int, val key: SortKey)
    ...
    object Rank : KeySortItem(
        R.id.action_sort_order_rank,
        R.string.sort_order_rank,
        SortKey.Rank
    )

    object Confidence : KeySortItem(
        R.id.action_sort_order_confidence,
        R.string.sort_order_confidence,
        SortKey.Confidence
    )

    object Source : KeySortItem(
        R.id.action_sort_order_source,
        R.string.sort_order_source,
        SortKey.Source
    )
