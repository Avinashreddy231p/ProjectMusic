...
import com.mardous.projectmusic.extensions.resources.hitTest
...
class PlaylistSongAdapter(
...
) : SongAdapter(activity, dataSet, itemLayoutRes, null, com.mardous.projectmusic.core.model.swipe.SwipeContext.PLAYLISTS, callback),
    ...
    fun saveSongs(playlistEntity: PlaylistEntity) {
        ...
        activity.lifecycleScope.launch(Dispatchers.IO) {
            libraryViewModel.insertSongs(playlistEntity.playListId, dataSet)
        }
    }
