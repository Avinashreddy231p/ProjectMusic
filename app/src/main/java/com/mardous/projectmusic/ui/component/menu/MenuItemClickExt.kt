...
package com.mardous.projectmusic.ui.component.menu
...
import com.mardous.projectmusic.extensions.getShareSongsIntent
...
import com.mardous.projectmusic.extensions.navigation.songDetailArgs
...
import com.mardous.projectmusic.ui.screen.tageditor.AlbumTagEditorActivity
import com.mardous.projectmusic.ui.screen.tageditor.ArtistTagEditorActivity
...
fun Song.onSongMenu(
    ...
    return when (menuItem.itemId) {
        ...
        R.id.action_add_to_mood -> {
            AssignToMetadataDialog.create(this, AssignMode.MOOD)
                .show(fragment.childFragmentManager, "ASSIGN_METADATA")
            true
        }

        R.id.action_add_to_tag -> {
            AssignToMetadataDialog.create(this, AssignMode.TAG)
                .show(fragment.childFragmentManager, "ASSIGN_METADATA")
            true
        }
