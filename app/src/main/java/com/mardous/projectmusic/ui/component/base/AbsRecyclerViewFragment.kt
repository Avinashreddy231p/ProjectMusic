...
import com.mardous.projectmusic.databinding.FragmentMainRecyclerBinding
import com.mardous.projectmusic.extensions.createProjectMusicBalloon
...
import com.mardous.projectmusic.ui.screen.other.ShuffleModeFragment
    ...
    override fun onStart() {
        ...
        _binding?.shuffleButton?.doOnLayout {
            viewLifecycleOwner.lifecycleScope.launch {
                delay(1000)
                val balloon = createProjectMusicBalloon("shuffle_button_tip") {
