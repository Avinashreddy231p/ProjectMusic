package com.mardous.projectmusic.ui.screen.player
...
import com.mardous.projectmusic.core.model.shuffle.ShuffleOperationState
...
import com.mardous.projectmusic.playback.ProgressObserver
import com.mardous.projectmusic.playback.getQueueItems
import com.mardous.projectmusic.playback.shuffle.ShuffleManager
import com.mardous.projectmusic.playback.toMediaItems
import com.mardous.projectmusic.playback.withExtras
import com.mardous.projectmusic.util.NOW_PLAYING_EXTRA_INFO
import com.mardous.projectmusic.util.Preferences
import com.mardous.projectmusic.util.REMEMBER_SHUFFLE_MODE
...
class PlayerViewModel(
    ...
    private val progressObserver by lazy { ProgressObserver(intervalMs = 100) }
