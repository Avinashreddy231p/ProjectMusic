...
import com.mardous.projectmusic.core.model.lyrics.LyricsViewSettings.Key
import com.mardous.projectmusic.data.local.lyrics.InstrumentalDetector
...
import java.io.File
import com.mardous.projectmusic.core.model.lyrics.LyricsViewSettings.Mode as LyricsViewMode
...
class LyricsViewModel(
    ...
    private fun createViewSettings(mode: LyricsViewMode): LyricsViewSettings {
        ...
        return LyricsViewSettings(
            ...
            vibrantBackgroundMode = com.mardous.projectmusic.util.Preferences.vibrantLyricsBackgroundMode,
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        when (key) {
            ...
            com.mardous.projectmusic.util.VIBRANT_LYRICS_BACKGROUND_MODE,
            Key.BLUR_EFFECT,
            Key.SHADOW_EFFECT,
