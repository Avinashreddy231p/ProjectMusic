...
class HomeBinding(homeBinding: FragmentHomeBinding) {
    ...
    val moods = homeBinding.homeContent.absPlaylists.moods
    val tags = homeBinding.homeContent.absPlaylists.tags
    val instruments = homeBinding.homeContent.absPlaylists.instruments
