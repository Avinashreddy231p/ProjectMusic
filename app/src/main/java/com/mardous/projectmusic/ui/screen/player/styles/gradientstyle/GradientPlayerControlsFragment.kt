...
package com.mardous.projectmusic.ui.screen.player.styles.gradientstyle
...
import com.mardous.projectmusic.databinding.FragmentGradientPlayerPlaybackControlsBinding
...
class GradientPlayerControlsFragment : AbsPlayerControlsFragment(R.layout.fragment_gradient_player_playback_controls) {
    ...
    override fun getTintTargets(scheme: PlayerColorScheme): List<PlayerTintTarget> {
        ...
        return listOfNotNull(
            binding.progressSlider.tintTarget(oldSliderColor, scheme.onSurfaceColor),
