...
) : SongAdapter(activity, playlist, R.layout.item_queue, sortMode = null, swipeContext = com.mardous.projectmusic.core.model.swipe.SwipeContext.QUEUE, callback = callback),
