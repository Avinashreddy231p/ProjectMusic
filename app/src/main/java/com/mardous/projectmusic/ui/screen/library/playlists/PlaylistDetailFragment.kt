...
import com.mardous.projectmusic.coil.playlistImage
...
import com.mardous.projectmusic.databinding.FragmentPlaylistDetailBinding
...
import com.mardous.projectmusic.extensions.media.isFavorites
import com.mardous.projectmusic.extensions.media.playlistInfo
import com.mardous.projectmusic.extensions.navigation.searchArgs
import com.mardous.projectmusic.extensions.resources.createFastScroller
...
import com.mardous.projectmusic.ui.adapters.song.PlaylistSongAdapter
...
import com.mardous.projectmusic.ui.dialogs.playlists.RemoveFromPlaylistDialog
...
class PlaylistDetailFragment : AbsMainActivityFragment(R.layout.fragment_playlist_detail),
    ...
    override fun songMenuItemClick(
        ...
        return when (menuItem.itemId) {
            R.id.action_remove_from_playlist -> {
                RemoveFromPlaylistDialog.create(playlist.playlistEntity.playListId, song.toSongEntity())
    ...
    override fun songsMenuItemClick(songs: List<Song>, menuItem: MenuItem) {
        when (menuItem.itemId) {
            R.id.action_remove_from_playlist -> {
                RemoveFromPlaylistDialog.create(playlist.playlistEntity.playListId, songs.map { it.toSongEntity() })
                    .show(childFragmentManager, "REMOVE_FROM_PLAYLIST")
            }
