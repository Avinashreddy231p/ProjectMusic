...
import com.mardous.projectmusic.databinding.FragmentSettingsBinding
import com.mardous.projectmusic.extensions.applyHorizontalWindowInsets
import com.mardous.projectmusic.extensions.getOnBackPressedDispatcher
...
import com.mardous.projectmusic.ui.screen.settings.search.SettingsSearchAdapter
...
class SettingsFragment : AbsMainActivityFragment(R.layout.fragment_settings), NavController.OnDestinationChangedListener {
    ...
    override fun onDestinationChanged(controller: NavController, destination: NavDestination, arguments: Bundle?) {
        val isComposeScreenWithInternalToolbar = destination.id == R.id.nav_home_preferences ||
                destination.id == R.id.nav_interface_preferences ||
                destination.id == R.id.nav_now_playing_preferences ||
                destination.id == R.id.nav_lyrics_preferences ||
                destination.id == R.id.nav_playback_preferences ||
                ...
                destination.id == R.id.nav_pending_scrobbles ||
                destination.id == R.id.nav_lastfm_profile ||
                destination.id == R.id.nav_swipe_actions_preferences
