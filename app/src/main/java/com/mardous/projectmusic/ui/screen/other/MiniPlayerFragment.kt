...
import com.mardous.projectmusic.coil.songImage
import com.mardous.projectmusic.core.model.player.ProgressState
import com.mardous.projectmusic.core.model.theme.NowPlayingButtonStyle
import com.mardous.projectmusic.databinding.FragmentMiniPlayerBinding
...
import com.mardous.projectmusic.extensions.resources.*
import com.mardous.projectmusic.ui.component.base.SkipButtonTouchHandler
...
import com.mardous.projectmusic.ui.theme.spotifyLightGrey
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.launchAndRepeatWithViewLifecycle {
            playerViewModel.colorSchemeFlow.collect { scheme ->
                val primary = scheme.primaryColor
                val onSurface = scheme.onSurfaceColor
                val onSurfaceVariant = scheme.onSurfaceVariantColor
                
                binding.progressBar.setIndicatorColor(primary)
                binding.progressBar.setTrackColor(primary.withAlpha(0.24f))
                binding.bottomProgressBar.setIndicatorColor(primary)
                binding.bottomProgressBar.setTrackColor(primary.withAlpha(0.24f))
