...
package com.mardous.projectmusic.ui.component.base
...
import com.mardous.projectmusic.MediaControllerOwner
...
import com.mardous.projectmusic.databinding.SlidingMusicPanelLayoutBinding
import com.mardous.projectmusic.extensions.applyWindowInsets
import com.mardous.projectmusic.extensions.currentFragment
import com.mardous.projectmusic.extensions.dip
import com.mardous.projectmusic.extensions.getBottomInsets
import com.mardous.projectmusic.extensions.hasS
import com.mardous.projectmusic.extensions.hasT
import com.mardous.projectmusic.extensions.isLandscape
import com.mardous.projectmusic.extensions.launchAndRepeatWithViewLifecycle
import com.mardous.projectmusic.extensions.resources.darkenColor
import com.mardous.projectmusic.extensions.resources.hide
import com.mardous.projectmusic.extensions.resources.isColorLight
import com.mardous.projectmusic.extensions.resources.peekHeightAnimate
import com.mardous.projectmusic.extensions.resources.show
import com.mardous.projectmusic.extensions.whichFragment
import com.mardous.projectmusic.ui.theme.spotifyGreen
import com.mardous.projectmusic.ui.theme.spotifyGrey
import com.mardous.projectmusic.ui.theme.spotifyBlack
import com.mardous.projectmusic.ui.IBackConsumer
import com.mardous.projectmusic.ui.screen.info.PlayInfoFragment
import com.mardous.projectmusic.ui.screen.library.LibraryViewModel
import com.mardous.projectmusic.ui.screen.library.search.SearchFragment
import com.mardous.projectmusic.ui.screen.lyrics.LyricsEditorFragment
import com.mardous.projectmusic.ui.screen.lyrics.LyricsViewModel
import com.mardous.projectmusic.ui.screen.other.MiniPlayerFragment
import com.mardous.projectmusic.ui.screen.permissions.PermissionsActivity
import com.mardous.projectmusic.ui.screen.player.PlayerViewModel
import com.mardous.projectmusic.ui.screen.player.styles.defaultstyle.DefaultPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.expressivestyle.ExpressivePlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.fullcoverstyle.FullCoverPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.gradientstyle.GradientPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.m3style.M3PlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.peekplayerstyle.PeekPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.plainstyle.PlainPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.spotify.SpotifyPlayerFragment
import com.mardous.projectmusic.ui.screen.player.styles.vibrantstyle.VibrantPlayerFragment
import com.mardous.projectmusic.util.ADAPTIVE_CONTROLS
import com.mardous.projectmusic.util.ADD_EXTRA_CONTROLS
import com.mardous.projectmusic.util.VIBRANT_BACKGROUND_ANIMATIONS
import com.mardous.projectmusic.util.VIBRANT_BACKGROUND_HIGH_QUALITY
import com.mardous.projectmusic.util.VIBRANT_BACKGROUND_GLOBAL
import com.mardous.projectmusic.util.CAROUSEL_EFFECT
import com.mardous.projectmusic.util.CIRCLE_PLAY_BUTTON
import com.mardous.projectmusic.util.ENABLE_ROTATION_LOCK
import com.mardous.projectmusic.util.HOLD_TAB_TO_SEARCH
import com.mardous.projectmusic.util.LIBRARY_CATEGORIES
import com.mardous.projectmusic.util.NOW_PLAYING_IMAGE_CORNER_RADIUS
import com.mardous.projectmusic.util.NOW_PLAYING_SCREEN
import com.mardous.projectmusic.util.NOW_PLAYING_SMALL_IMAGE
import com.mardous.projectmusic.util.PLAYER_BLUR_RADIUS
import com.mardous.projectmusic.util.Preferences
import com.mardous.projectmusic.util.SQUIGGLY_SEEK_BAR
import com.mardous.projectmusic.util.SWIPE_DOWN_TO_DISMISS
import com.mardous.projectmusic.util.UITheme
import com.mardous.projectmusic.util.TAB_TITLES_MODE
...
abstract class AbsSlidingMusicPanelActivity : AbsBaseActivity(),
    ...
    private fun setupGlobalBackground() {
        ...
        if (isGlobalEnabled) {
            binding.globalBackgroundView.setContent {
                ...
                com.mardous.projectmusic.ui.theme.ProjectMusicTheme {
                    VibrantBackground(
    ...
    private fun setupBottomSheet() {
        ...
        if (Preferences.eraSurfaceMaterial == EraSurfaceMaterial.GLASS) {
