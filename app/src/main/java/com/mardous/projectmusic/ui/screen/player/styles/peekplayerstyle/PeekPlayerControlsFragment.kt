...
package com.mardous.projectmusic.ui.screen.player.styles.peekplayerstyle
...
import com.mardous.projectmusic.databinding.FragmentPeekPlayerPlaybackControlsBinding
...
class PeekPlayerControlsFragment : AbsPlayerControlsFragment(R.layout.fragment_peek_player_playback_controls) {
    ...
    override fun getTintTargets(scheme: PlayerColorScheme): List<PlayerTintTarget> {
        ...
        return listOfNotNull(
            binding.progressSlider.tintTarget(oldSliderColor, newSliderColor),
