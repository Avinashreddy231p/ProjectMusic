...
package com.mardous.projectmusic.ui.screen.player.styles.fullcoverstyle
...
import com.mardous.projectmusic.databinding.FragmentFullCoverPlayerPlaybackControlsBinding
...
class FullCoverPlayerControlsFragment : AbsPlayerControlsFragment(R.layout.fragment_full_cover_player_playback_controls) {
    ...
    override fun getTintTargets(scheme: PlayerColorScheme): List<PlayerTintTarget> {
        ...
        return listOfNotNull(
            ...
            binding.progressSlider.tintTarget(oldSliderColor, scheme.primaryColor),
