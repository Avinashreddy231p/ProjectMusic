...
import com.mardous.projectmusic.databinding.FragmentPlayerAlbumCoverBinding
import com.mardous.projectmusic.extensions.isLandscape
import com.mardous.projectmusic.extensions.keepScreenOn
...
import com.mardous.projectmusic.extensions.resources.PROJECT_MUSIC_ANIM_TIME
import com.mardous.projectmusic.ui.adapters.pager.CustomFragmentStatePagerAdapter
import com.mardous.projectmusic.ui.component.base.AbsPlayerFragment
import com.mardous.projectmusic.ui.component.transform.CarouselPagerTransformer
...
import com.mardous.projectmusic.ui.screen.player.cover.page.ImageFragment
import com.mardous.projectmusic.ui.screen.player.cover.page.ImageFragment.ColorReceiver
import com.mardous.projectmusic.util.Preferences
import com.mardous.projectmusic.util.SWIPE_ON_COVER
...
class CoverPagerFragment : Fragment(R.layout.fragment_player_album_cover),
    ...
    fun showLyrics(isForced: Boolean = false) {
        ...
        animatorSet.duration = PROJECT_MUSIC_ANIM_TIME
        animatorSet.doOnEnd {
